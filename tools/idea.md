...
#### plujin jrebel  
#active code  
ks7u6sCdw4AKnRX/LKIE3+/tWTIVrDa5skvaBnYKhQaroFkFMecKO1OcpDZCs/rlAKfoiSyM3/nqKI8sxBOiZnKqf9rN+473BRfutfkoduYfAd3sUF0q6i19X5QN4EH6W9I0pQ==  

#### junit  
安装:  
plugin 收搜 junit generator   
配置代理  
IntelliJ IDEA JUnit Generator自动创建测试用例到指定(maven)test目录  
1. 打开File->Settings  
...
Ctrl+Enter，导入包，自动修正  
Ctrl+Alt+L，格式化代码  
Ctrl+Alt+I，将选中的代码进行自动缩进编排，这个功能在编辑 JSP 文 件时也可以工作  
Ctrl+Alt+O，优化导入的类和包  
Ctrl+R，替换文本  
Ctrl+F，查找文本  
